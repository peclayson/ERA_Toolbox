...
uicontrol(era_gui,'Style','push','fontsize',era_prefs.guis.fsize,...
    'HorizontalAlignment','center',...
    'String','Back',...
    'Position', [.5*figwidth/9 row figwidth/6 50],...
...
uicontrol(era_gui,'Style','push','fontsize',era_prefs.guis.fsize,...
    'HorizontalAlignment','center',...
    'String','Analyze',...
    'Position', [2.5*figwidth/9 row figwidth/6 50],...
...
uicontrol(era_gui,'Style','push','fontsize',era_prefs.guis.fsize,...
    'HorizontalAlignment','center',...
    'String','Preferences',...
    'Position', [4.5*figwidth/9 row figwidth/6 50],...
...
uicontrol(era_gui,'Style','push','fontsize',era_prefs.guis.fsize,...
    ...
    'Position', [6.5*figwidth/9 row figwidth/6 50],...
